# Building graph for Telegram chats, channels, and their neighbors
...
![graph example](building-telegram-graph-04.png)
...
Below you can find the [final script](https://github.com/freefd/utils/blob/master/telegram_graph.py) <sup id="a11">[11](#f11)</sup> that builds our Plantuml file.
...
![Username graph](building-telegram-graph-05.png)
...
<b id="f3">3</b>. [PlantUML tool allowing to create diagrams from a plain text language](https://plantuml.com/) [↩](#a3)<br/>
...
<b id="f9">9</b>. [Telethon: Entities](https://docs.telethon.dev/en/stable/concepts/entities.html) [↩](#a9)<br/>
<b id="f10">10</b>. [Telethon: Get full channel info](https://tl.telethon.dev/methods/channels/get_full_channel.html) [↩](#a10)<br/>
...
<b id="f17">17</b>. [Social Energy prices](https://tg.segroup.me/en) [↩](#a17)<br/>
